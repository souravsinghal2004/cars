...
export const AddCarForm = () => {
  ...
  useEffect(() => {
    if (processImageResult?.success) {
      ...
      const mileage = parseInt(carDetails.mileage);
setValue("mileage", isNaN(mileage) ? "5" : mileage.toString());

      setValue("transmission", carDetails.transmission);
      setValue("description", carDetails.description);

   
const rawPrice = carDetails.price || "";
...
if (matches && matches.length > 0) {
  ...
  setValue("price", maxPrice.toString());
} else {
  setValue("price", "");
}
