...
export function CarDetails({ car, testDriveInfo }) {
    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${car.year} ${car.make} ${car.model} on Wheel-Deal!`,
  ...
  const handleBookTestDrive = () => {
    if (!isSignedIn) {
      toast.error("Please sign in to Book your car");
      router.push("/sign-in");
      return;
    }
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Wheel-Deal Car Loan Calculator</DialogTitle>
          ...
          <Card className="my-6">
            <CardContent className="p-4">
              ...
              <a href="mailto:help@Wheel-Deal.in">
